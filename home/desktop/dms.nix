...
let
  ...
  defaultSettingsFile =
    builtins.toFile "dms-settings.json" # json
      ''
        {
          "currentThemeName": "custom",
          "customThemeFile": "${config.xdg.configHome}/DankMaterialShell/stylix-colors.json",
          ...
          "weatherLocation": "武汉区, 湖北省",
          "weatherCoordinates": "30.498171521727,114.53183738528003",
