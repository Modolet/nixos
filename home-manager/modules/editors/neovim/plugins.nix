...
let
  inherit (helpers)
    mkExtra mkLangExtra mkCodingExtra mkEditorExtra mkUIExtra mkAIExtra
    mkCategoryExtra withVimPlugins withPkgs vimPlugins miniPlugin;
  ...
  miniPlugins = [ (miniPlugin "ai") (miniPlugin "icons") (miniPlugin "pairs") ];
  ...
  basePlugins = (withVimPlugins basePluginNames) ++ miniPlugins
    ++ specialPlugins;
